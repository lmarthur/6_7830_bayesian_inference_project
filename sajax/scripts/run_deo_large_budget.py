"""
Run DEO trials for the large budget point (5_000_000 LDE)
and save to results_deo_large.json.

Results are written incrementally so the script is safe to interrupt and restart.

Usage:
    python run_deo_large_budget.py
"""
...
ALGO       = "deo"
NEW_BUDGETS = [5_000_000]
OUT_PATH   = SCALING_OUT_DIR / f"results_{ALGO}_large.json"
